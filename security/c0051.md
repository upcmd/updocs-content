...
```
    ...
    "PwcghQ+FkmnE/+rgdm0BJZiGCoN2Ci941i4rDjsKSYo="
    ...
    (*core.Cache)({
      ...
      "bank_password_encrypted": "PwcghQ+FkmnE/+rgdm0BJZiGCoN2Ci941i4rDjsKSYo=",
    ...
    -
    bank password encrypted [PwcghQ+FkmnE/+rgdm0BJZiGCoN2Ci941i4rDjsKSYo=]
    -
     .. ok
    cmd( 3):
    echo "bank password [{{.bank_password}}]"
