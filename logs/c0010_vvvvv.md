...
```
    ...
    Main config:
              ...
              AbsWorkDir -> /up_project/up
                TaskFile -> c0010
                 Verbose -> vvvvv
              ModuleName -> compassionate_albattani2
               ShellType -> /bin/sh
           MaxCallLayers -> 8
    ...
    -------full vars in scopes------
    (*impl.Scopes)(0xc0001c9280)((len=5 cap=5) {
     (impl.Scope) {
    ...
    module: [compassionate_albattani2] instance id: [dev]
    ...
    compassionate_albattani2: overall final exec vars:
