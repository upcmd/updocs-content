...
```
    ...
    Main config:
              ...
              AbsWorkDir -> /up_project/up
                TaskFile -> c0010
                 Verbose -> vvvvv
              ModuleName -> berserk_ardinghelli3
               ShellType -> /bin/sh
           MaxCallLayers -> 8
    ...
    -------full vars in scopes------
    (*impl.Scopes)(0xc0001ed220)((len=5 cap=5) {
     (impl.Scope) {
    ...
    module: [berserk_ardinghelli3] instance id: [dev]
    ...
    berserk_ardinghelli3: overall final exec vars:
