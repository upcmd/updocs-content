...
```
    ...
    -
    {
      ...
      "headers": {
        ...
        "X-Amzn-Trace-Id": "Root=1-5f637734-9a842eea27e67f10a3d5a9fe"
      }, 
    ...
    "map[Accept:application/json Host:httpbin.org User-Agent:curl/7.70.0 X-Amzn-Trace-Id:Root=1-5f637734-9a842eea27e67f10a3d5a9fe]"
    ...
    (*core.Cache)({
      ...
      "up_runtime_task_layer_number": 0,
      "api_response_headers": "map[Accept:application/json Host:httpbin.org User-Agent:curl/7.70.0 X-Amzn-Trace-Id:Root=1-5f637734-9a842eea27e67f10a3d5a9fe]",
