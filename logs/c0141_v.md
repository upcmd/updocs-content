...
```
    ...
    cmd( 1):
    {
      ...
      "headers": {
        ...
        "X-Amzn-Trace-Id": "Root=1-5f14681d-6b868990ebb5a64852219450"
      }, 
    ...
    "map[Accept:application/json Host:httpbin.org User-Agent:curl/7.70.0 X-Amzn-Trace-Id:Root=1-5f14681d-6b868990ebb5a64852219450]"
    ...
    ~SubStep4: [inspect:  ]
     1: inspect[exec_vars](*core.Cache)({
      ...
      "api_response_headers": "map[Accept:application/json Host:httpbin.org User-Agent:curl/7.70.0 X-Amzn-Trace-Id:Root=1-5f14681d-6b868990ebb5a64852219450]",
