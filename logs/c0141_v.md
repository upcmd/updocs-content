...
```
    ...
    module: [stupefied_kirch1] instance id: [dev]
    ...
    cmd( 1):
    {
      ...
      "headers": {
        ...
        "X-Amzn-Trace-Id": "Root=1-5ef62b67-9b1155fdf078b2aaa9d8c628"
      }, 
    ...
    "map[Accept:application/json Host:httpbin.org User-Agent:curl/7.70.0 X-Amzn-Trace-Id:Root=1-5ef62b67-9b1155fdf078b2aaa9d8c628]"
    ...
    ~SubStep4: [inspect:  ]
     1: inspect[exec_vars](*core.Cache)({
      ...
      "api_response_headers": "map[Accept:application/json Host:httpbin.org User-Agent:curl/7.70.0 X-Amzn-Trace-Id:Root=1-5ef62b67-9b1155fdf078b2aaa9d8c628]",
