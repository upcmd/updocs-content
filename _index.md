...
### Chapter 10 [environment vars](/env-vars/)
  ...
  6. [environment vars](/env-vars/pure/)
  7. [virtualEnv cmd](/env-vars/c0193/)
...
### Chapter 11 [security](/security/)
  ...
  4. [use valut to store secrets](/security/c0201/)
  5. [encrypteAesWithVault template func to retrieve and encrypt](/security/c0202/)
  6. [mask senstive info in shell execution](/security/c0203/)
  7. [retrieve secret from valut](/security/c0204/)
...
### Chapter 23 [modules](/module/)
  ...
  3. [module repo auth](/module/use-auth/)
  4. [HelloWorld example](/module/0001/)
  5. [simple vars](/module/0002/)
  6. [return value](/module/0003/)
  7. [jailed exec context](/module/0004/)
  8. [Complex vars](/module/0005/)
  9. [Complex call layers](/module/0006/)
  10. [use alias](/module/0007/)
  11. [moule lock](/module/0008/)
  12. [module validation](/module/0009/)
  13. [multi module calls](/module/0010/)
  14. [module multi vesioning](/module/0011/)
  15. [max module restriction](/module/f0012/)
  16. [manage indirect dependencies](/module/0013/)
  17. [&lt;no value&gt;](/module/0014/)
